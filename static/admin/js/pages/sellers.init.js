...
function loadCharts() {
    var e = getChartColorsArray("chart-seller1"), e = (e && (e = {
        ...
        }, new ApexCharts(document.querySelector("#chart-seller1"), e).render()), getChartColorsArray("chart-seller2")),
        e = (e && (e = {
        ...
        }, new ApexCharts(document.querySelector("#chart-seller2"), e).render()), getChartColorsArray("chart-seller3")),
        e = (e && (e = {
        ...
        }, new ApexCharts(document.querySelector("#chart-seller3"), e).render()), getChartColorsArray("chart-seller4")),
        e = (e && (e = {
        ...
        }, new ApexCharts(document.querySelector("#chart-seller4"), e).render()), getChartColorsArray("chart-seller5")),
        e = (e && (e = {
        ...
        }, new ApexCharts(document.querySelector("#chart-seller5"), e).render()), getChartColorsArray("chart-seller6")),
        e = (e && (e = {
        ...
        }, new ApexCharts(document.querySelector("#chart-seller6"), e).render()), getChartColorsArray("chart-seller7")),
        e = (e && (e = {
        ...
        }, new ApexCharts(document.querySelector("#chart-seller7"), e).render()), getChartColorsArray("chart-seller8"));
    e && (e = {
    ...
    }, new ApexCharts(document.querySelector("#chart-seller8"), e).render())
}

var url = "/static/json/", sellerListData = "", editList = !1, prevButton = document.getElementById("page-prev"),
    nextButton = document.getElementById("page-next"), currentPage = 1, itemsPerPage = 8, getJSON = function (e, t) {
        var r = new XMLHttpRequest;
        r.open("GET", url + e, !0), r.responseType = "json", r.onload = function () {
            var e = r.status;
...
function findNextId() {
    var e, t;
    return 0 === sellerListData.length ? 0 : (e = fetchIdFromObj(sellerListData[sellerListData.length - 1])) <= (t = fetchIdFromObj(sellerListData[0])) ? t + 1 : e + 1
}

function sortElementsById() {
    loadSellerList(sellerListData.sort(function (e, t) {
...
function paginationEvents() {
    ...
    t.innerHTML = "";
    for (var r = 1; r < e() + 1; r++) t.innerHTML += "<div class='page-item'><a class='page-link clickPageNumber' href='javascript:void(0);'>" + r + "</a></div>";
    document.addEventListener("click", function (e) {
        "A" == e.target.nodeName && e.target.classList.contains("clickPageNumber") && (currentPage = e.target.textContent, loadSellerList(sellerListData, currentPage))
    }), selectedPage()
}

function pageEvent(e) {
    0 == e.length ? (document.getElementById("pagination-element").style.display = "none", document.getElementById("noresult").classList.remove("d-none")) : (document.getElementById("pagination-element").style.display = "flex", document.getElementById("noresult").classList.add("d-none"));
    for (var t = document.getElementById("page-num"), r = (t.innerHTML = "", Math.ceil(e.length / itemsPerPage)), a = 1; a < r + 1; a++) t.innerHTML += "<div class='page-item'><a class='page-link clickPageNumber' href='javascript:void(0);'>" + a + "</a></div>"
}

getJSON("seller-list.json", function (e, t) {
    null !== e ? console.log("Something went wrong: " + e) : (loadSellerList(sellerListData = t, currentPage), sortElementsById())
});
var searchResultList = document.getElementById("searchResultList"),
    categoryInput = (searchResultList.addEventListener("keyup", function () {
        var t, e = searchResultList.value.toLowerCase();
        t = e, loadSellerList(sellerListData.filter(function (e) {
            return -1 !== e.shop[0].name.toLowerCase().indexOf(t.toLowerCase()) || -1 !== e.seller.toLowerCase().indexOf(t.toLowerCase())
        }), currentPage)
    }), new Choices(document.getElementById("category-select"), {searchEnabled: !1}));
categoryInput.passedElement.element.addEventListener("change", function (e) {
    var t = e.detail.value;
    loadSellerList("All" != e.detail.value ? sellerListData.filter(e => e.category == t) : sellerListData, currentPage)
}, !1);